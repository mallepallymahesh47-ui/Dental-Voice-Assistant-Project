...
## 🏗️ Architecture
User (Phone Call) -> Twilio (Media Stream) -> WebSocket Server (Python) -> Deepgram (Speech-to-Text & Text-to-Speech) -> LLM (Function Calling) -> Backen Functions (Booking Logic) -> MongoDB (Data Storage) 
